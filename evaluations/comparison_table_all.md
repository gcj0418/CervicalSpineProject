...
所有原始结果已归档至 `evaluations/` 目录，以下为对照索引：

| 结果 | evaluations/ 文件 |
|------|------------------|
| VLD RENJI e60 | `vld_renji_e60.md` |
| VLD RENJI e60 + TTA | `vld_renji_e60_tta.md` |
| VLD RUIJIN e100 | `vld_ruijin_e100.md` |
| D-CeLR RENJI e60 | `dcelr_renji_e60.md` |
| D-CeLR RENJI 改进 e75 | `dcelr_renji_improved.md` |
| D-CeLR RUIJIN e60 | `dcelr_ruijin_e60.md` |
| D-CeLR RUIJIN 改进 e63 | `dcelr_ruijin_improved.md` |
| HRNet RENJI 预训练 e60 | `hrnet_renji_pretrained.md` |
| HRNet RUIJIN 预训练 e60 | `hrnet_ruijin_pretrained.md` |
| Ensemble RENJI | `ensemble_renji.md` |
| Ensemble RUIJIN | `ensemble_ruijin.md` |
| 拆分 VLD 融合 | `split_vld_fusion.md` |
| 拆分实验记录 | `SPLIT_EXPERIMENT_SUMMARY.md` |
| 图表 | `outputs/paper_figures/`（仍保留） |
